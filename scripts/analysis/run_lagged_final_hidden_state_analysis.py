...
from structure_comparison.brain import BrainTargets, build_brain_design_matrix, load_brain_targets
...
def build_final_hidden_state_targets(
    ...
    token_stream = extract_global_tokens(
        transcript_paired_path=feature_run_dir / "transcript_paired_records.jsonl",
