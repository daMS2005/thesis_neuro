...
from structure_comparison.artifacts import load_predictor_feature_keys, select_lm_target_feature_keys
...
def main() -> int:
    ...
    selected_features_path = feature_run_dir / "selected_features_for_alignment.jsonl"
    feature_concepts_path = feature_run_dir / "feature_concepts.jsonl"
    full_transcript_path = feature_run_dir / "transcript_paired_records.jsonl"
